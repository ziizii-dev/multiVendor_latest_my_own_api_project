                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror"  placeholder="Add User Name" />
                                        @error('username')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror "   placeholder="Add User Full Name" />
                                        @error('name')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror "  placeholder="Add User Email"  />
                                        @error('email')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror "  placeholder="Add User Phone" />
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror " placeholder="Add Your Address" />
                                        @error('address')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        @enderror "  placeholder="Add Password" />
                                        @error('password')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
