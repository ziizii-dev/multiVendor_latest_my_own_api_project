...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Add Roles Peimission </div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Add Roles Peimission </li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                                ...
                                <form id="myForm" method="post" action="{{ route('role.permission.store') }}"  >
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            ...
                                            <select  name="role_id"
                                                class="form-select mb-3 @error('role_id') is-invalid
                    @enderror"
