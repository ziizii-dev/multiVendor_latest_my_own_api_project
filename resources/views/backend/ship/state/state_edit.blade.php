 ...
 <form id="myForm" method="POST" action="{{ route('update#state') }}" >
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
                    <label for="">Select Disvision</label>
...
<div class="row mb-3">
	 	...
	 	<select name="district_id" class="form-select mb-3 @error('district_id') is-invalid
         @enderror" aria-label="Default select example">
           ...
           <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="state_name" class="form-control @error('state_name') is-invalid
                    @enderror"  value="{{ $state->state_name }}" />
                    @error('state_name')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
