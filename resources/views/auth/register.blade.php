                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="email" id="email" class="@error('email') is-invalid
                                            ...
                                            <div class="form-group">
                                                <input class="@error('password') is-invalid

                                                @enderror" id="password" type="password" name="password" placeholder="Password" />
                                                @error('password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <input id="password_confirmation" class="@error('password_confirmation') is-invalid

                                                @enderror" type="password" name="password_confirmation" placeholder="Confirm password" />
