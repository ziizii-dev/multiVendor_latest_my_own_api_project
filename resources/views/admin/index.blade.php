    ...
    <div class="page-content">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                    ...
                    <div class="card radius-10 bg-gradient-deepblue">
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">${{number_format( $today,0,'',',') }}USD</h5>
                            <div class="ms-auto">
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">${{number_format( $month,0,'',',') }}USD</h5>
                            <div class="ms-auto">
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">${{number_format( $year,0,'',',') }}USD</h5>
                            <div class="ms-auto">
                ...
                <div class="col">
                    <div class="card radius-10 bg-gradient-ibiza">
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">{{number_format(count($pending),0,'',',') }}</h5>
                            <div class="ms-auto">
                ...
                <div class="col">
                    <div class="card radius-10 bg-gradient-ibiza">
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">{{number_format(count($vendor),0,'',',') }}</h5>
                            <div class="ms-auto">
                                <i class='bx bx-envelope fs-3 text-white'></i>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card radius-10 bg-gradient-ibiza">
                     <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">{{number_format(count($customer),0,'',',') }}</h5>
                            <div class="ms-auto">
                                <i class='bx bx-envelope fs-3 text-white'></i>
                            </div>
                        </div>
