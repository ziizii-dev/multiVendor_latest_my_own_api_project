...
<div class="product-rate-cover">
    ...
    <span class="font-small ml-5 text-muted"> ({{ number_format(count($reviewcount),0,'',',')}} reviews)</span>
</div>
                           ...
                           <div class="product-price">
                               ...
                               <span class="old-price">${{number_fomrat($product->selling_price,0,'',',')}}</span>
                           </div>
                           @endif
                ...
                <div class="single-post clearfix">
                    ...
                    <div class="content pt-10">
                        ...
                        <div class="product-price">
                            ...
                            <del class="old-price">${{number_foramt($product->selling_price,0,'',',')}}</del>
                        </div>
                        @endif
