...
<form method="post" action="{{ route('checkout.store') }}">
    ...
    <div class="row">
        <div class="form-group col-lg-6">
            <input  class="@error('shipping_name') is-invalid
            @enderror""  type="text"  name="shipping_name" value="{{ Auth::user()->name }}" >
            @error('shipping_name')
        ...
        <div class="form-group col-lg-6">
            <input class="@error('district_id') is-invalid
            @enderror""  type="email"  name="shipping_email" value="{{ Auth::user()->email }}">
            @error('district_id')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
    ...
    <div class="row shipping_calculator">
        ...
        <div class="form-group col-lg-6">
      <input class="@error('shipping_phone') is-invalid
      @enderror""   type="text" name="shipping_phone" value="{{ Auth::user()->phone }}">
      @error('shipping_phone')
                ...
                @enderror
                     ...
                     <div class="row shipping_calculator">
                        ...
                        <div class="form-group col-lg-6">
                            <input class="@error('post_code') is-invalid
                            @enderror"" type="text" name="post_code" placeholder="Post Code *">
                            @error('post_code')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
