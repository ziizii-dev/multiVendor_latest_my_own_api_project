  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>MyShop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               MyShop Head Office
               Email:ziizii.dev@gmail.com <br>
               Mob:09123456789 <br>
               NIKO 0001,Yizeo:#9 <br>
...
<h3>Products</h3>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span>${{number_format($order->amount,0,'',',') }}</h2>
            <h2><span style="color: green;">Total:</span> ${{number_format($order->amount,0,'',',') }}</h2>
    </tr>
  </table>
