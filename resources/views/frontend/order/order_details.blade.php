...
<div class="col-md-9">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
               <div class="card-header" style="background:#b1c9f8"><h4>Shipping Details</h4> </div>
               <hr>
               <div class="card-body">
...
<!-- // End col-md-6  -->
        ...
        <div class="col-md-6">
            <div class="card">
               <div class="card-header" style="background:#b1c9f8"><h4>Order Details
    ...
    <tbody>
        ...
        @foreach($orderItem as $item)
         <tr>
            ...
            @endif
            <td class="col-md-1">
                <label>{{number_format ($item->qty,0,'',',' )}} </label>
            </td>

            <td class="col-md-3">
                <label>${{ $item->price }}/perone <br> Total = ${{number_format( $item->price * $item->qty,0,'',',') }}   </label>
            </td>
...
<div class="">
    ...
    <div class="form-group" style=" font-weight: 600; font-size: initial; color: #000000;">
                        ...
                        <textarea name="return_reason" class="form-control @error('return_reason') is-invalid
                        @enderror" style="width:40%;"></textarea>
                        @error('return_reason')
