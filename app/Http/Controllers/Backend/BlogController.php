...
public function AddBlogPost(){
    $blogcategory = BlogCategory::where('delete_status',1)->latest()->get();
   ...
   if(isset($blogpost)){
    ...
    private function blogpostValidationCheck($request){
        Validator::make($request->all(),[
            ...
            'post_image'=>'mimes:jpeg,jpg,png,webp,gif'
    ...
    public function BlogDetails($id,$slug){
        $blogcategoryies = BlogCategory::where('delete_status',1)
                                          ->latest()
                                          ->get();
        $blogdetails = BlogPost::where('delete_status',1)->findOrFail($id);
